...
public class Individual {
    ...
    public Individual(Schedule schedule) {
        ...
        for (StudentCase group : schedule.getGroupsAsArray()) {
            ...
            for (int courseId : group.getCourseIds()) {
                ...
                Subject course = schedule.getCourse(courseId);
    ...
    public void setFitness(double selective) {
