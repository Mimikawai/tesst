...
//import vn.com.vnptepay.service.impl.CallToMerchant;
...
//	private static final FileLogger log = new FileLogger(BaseConfig.class);
	...
	public void loadProperties(){
		...
		if (!loadConfigResult){
			try{
//				log.info("Path config = " +getFullConfigPath());
